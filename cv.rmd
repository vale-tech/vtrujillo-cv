...
```{r}
if(params$pdf_mode) {
  cat("View this CV online at _valetrujillo.com_")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://www.valetrujillo.com/cv/Trujillo%20V%20Resume.pdf)")
}
```
